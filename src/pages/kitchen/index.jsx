...
export const Kitchen = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (selectedDates.length === 2) {
      ...
      setSelectedDates([]);
      setFeedback({ type: "success", message: "Kitchen reservation added!" });
    }
  };
  ...
  return (
    <div className="reservation-container">
      <h1 className="page-title">Kitchen + Meeting Area</h1>
      ...
      <form onSubmit={onSubmit} className="date-range-form" aria-label="Kitchen date range reservation form">
